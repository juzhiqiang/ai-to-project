在 services/api 的 LangChain 层中，设计 UI 响应协议并实现 Structured Output 约束，严格按以下要求执行：

1. 类型定义：
   - 新建 services/api/src/llm/ui-protocol/ui-types.ts
...
2. Zod Schema：
   - 新建 services/api/src/llm/ui-protocol/ui-schemas.ts
...
3. UI 响应服务（Structured Output）：
   - 新建 services/api/src/llm/ui-protocol/ui-response.service.ts
...
5. UI Action 处理服务：
   - 新建 services/api/src/llm/ui-protocol/ui-action.service.ts
